...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">تعديل الوظيفة</h1>
        ...
        <div class="card shadow mb-4 text-right">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">تعديل الوظيفة</h6>
            </div>
            <form method="POST" action="{{route('jobs.update', ['CustomerJob' => $job->id])}}">
                @csrf
                @method('PUT')
