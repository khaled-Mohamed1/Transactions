...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{route('users.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> إالغاء<i
    ...
    <div class="card shadow mb-4 text-right">
        ...
        <form method="POST" action="{{route('users.update', ['user' => $user->id])}}">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('users.index') }}">إالغاء</a>
            </div>
        </form>
    </div>
