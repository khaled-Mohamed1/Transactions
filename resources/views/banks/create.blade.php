...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">اضافة بنك</h1>
            <a href="{{route('banks.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">رجوع <i
        ...
        <div class="card shadow mb-4 text-right">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">اضافة بنك جديد</h6>
            </div>
            <form method="POST" action="{{route('banks.store')}}">
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('banks.index') }}">إلغاء</a>
                </div>
            </form>
        </div>
