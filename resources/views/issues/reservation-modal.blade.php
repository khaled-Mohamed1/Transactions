...
<div class="modal fade" id="reservationModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalExample"
     aria-hidden="true">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalExample">هل تريد فك حجز عن رقم القضية {{$issue->issue_NO}}؟</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body text-right">
                <form id="issue-reservation-form" method="POST" action="{{route('issues.export.WORD.reservation',['issue'=>$issue->id])}}">
                    @csrf
                    <div class="row">
