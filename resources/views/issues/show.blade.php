        ...
        <div class="row">
            <div class="col-md-12 border-right">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered text-right" id="dataTable" width="100%" cellspacing="0">
                                ...
                                @forelse($issue->customerIssues as $customer)
                                    <tr>
                                        <td><a href="{{route('customers.show',['customer' => $customer->customer_id])}}">{{ $customer->IssueCustomer->customer_NO }}</a></td>
                                        ...
                                        <td>{{ $customer->IssueCustomer->created_at }}</td>
                                        <td>
                                            ...
                                            @elseif($customer->IssueCustomer->account < 0)
                                                <span class="text-success">{{ $customer->IssueCustomer->account }}</span>
                                            @else
                ...
                @forelse($issue->customerIssues as $customer)
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-right">العميل {{$customer->IssueCustomer->full_name}}</h6>
